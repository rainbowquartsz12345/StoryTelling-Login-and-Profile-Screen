...
export default class StoryCard extends Component {
    ...
    async initiateTTS(title, author, story, moral) {
        const currentColor = this.state.speakerColor;//acc


        this.setState({ speakerColor: currentColor === 'gray' ? 'orange' : 'gray' })
                        ...
                        <ScrollView style={styles.storyCard}>
                            ...
                            <View style={styles.dataContainer}>
                                <View style={styles.titleTextContainer}>
                                    {/* Add the text for title , author , created_on*/}
                                    ...
                                    <Text style={styles.storyAuthorText}> {this.props.route.params.created_on}</Text>
                                </View>
                            ...
                            <View style={styles.storyTextContainer}>
                                {/* Add the text for story and the moral*/}
